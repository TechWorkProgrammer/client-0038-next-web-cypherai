...
const TelegramBanner: React.FC = () => {
    return (
        <motion.div
            className="py-12 md:py-20 text-center h-full"
            initial={{opacity: 0, y: 50}}
            whileInView={{opacity: 1, y: 0}}
            viewport={{once: false}}
            transition={{duration: 0.8, ease: "easeOut"}}
        >
            <h1 className="text-1xl sm:text-2xl md:text-3xl font-bold text-white drop-shadow-lg mb-4">
            ...
            <p className="text-secondary-600 text-sm sm:text-base md:text-lg mb-8">
